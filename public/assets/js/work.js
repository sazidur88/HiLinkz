! function(t) {
    ...
    119: function(t, e, i) {
        ...
        }, HorizontalLayoutSlider.prototype.scrollToEnd = function() { if (this.viewport) this.viewport.scrollLeft(this.data.scrollWidth) }
    },
    138: function(t, e) {
        var e = void 0,
            t = void 0;
    ...
    262: function(t, e, i) {
        ...
        }, ResponsiveMenu.toggleResponsive = function t(e, i) { n(e).toggleClass("u-enable-responsive", i) }, ResponsiveMenu.prototype.close = function close(menu, t) { if (!window.app || !window.app.modes) { if (ResponsiveMenu.isActive(menu)) this.closeMenu(menu, t) } else if (this.closeMenu(menu, t), ResponsiveMenu.isOffcanvasMode(menu)) app.modes().resetOffCanvas() }, ResponsiveMenu.prototype.closeMenu = function t(menu, e) {
        ...
        }, ResponsiveMenu.prototype.open = function t(menu) { if (this.root.addClass("menu-overlay"), !window.app || !window.app.modes) { if (!ResponsiveMenu.isActive(menu)) this.openMenu(menu) } else if (this.openMenu(menu), ResponsiveMenu.isOffcanvasMode(menu)) app.modes().setOffCanvas() }, ResponsiveMenu.prototype.openMenu = function t(menu) {
        ...
        ! function(a, factory) {
            ...
            return function(template, t, items, e) {
                ...
                var l = function() { return { x: 0, y: 0 } },
                    ...
                    Nt = function(t) { if (zt[t]) Pt(t); if (!zt[t]) Rt++, zt[t] = {} },
                    Ht = function() {
                        for (var t in zt)
                    ...
                    Bt = function(t, e, i, d, n, o, a) {
                        ...
                        var u = function() {
                            if (zt[t]) {
                                if (l = ct() - s, l >= d) { if (Pt(t), o(i), a) a(); return }
                        ...
                        init: function() {
                            if (!u && !f) {
                                ...
                                if (ut("initialZoomInEnd", function() {
                                        ...
                                        Ct()
                                    }), n.setContent(F[1], p), n.updateCurrItem(), ft("afterInit"), !V) A = setInterval(function() { if (!Rt && !le && !ye && C === n.currItem.initialZoomLevel) n.updateSize() }, 1e3);
                    ...
                    ti = function(t) {
                        if (!("mousedown" === t.type && t.button > 0)) {
                            ...
                            if (!oe || "mousedown" !== t.type) {
                                ...
                                var o = Qe(t),
                                    a = o.length;
                                if (ge = null, Ht(), !le || 1 === a) le = Ie = true, i.bind(window, w, n), ie = Oe = Ee = ne = ve = ce = ue = fe = false, Ae = null, ft("firstTouchStart", o), wt(g, y), v.x = v.y = 0, wt(Gt, o[0]), wt(Kt, Gt), Qt.x = O.x * E, te = [{ x: Gt.x, y: Gt.y }], Zt = Vt = ct(), St(C, true), Pe(), Ne();
                ...
                var zi = { history: true, galleryUID: 1 },
                    Ri, Pi, Ni, Hi, Bi, qi, Wi, Ui, Zi, ji, Xi, $i, Gi = function() { return Xi.hash.substring(1) },
                    Ki = function() { if (Ri) clearTimeout(Ri); if (Ni) clearTimeout(Ni) },
                    Yi = function() {
                        var t = Gi(),
                            e = {};
                    ...
                    Qi = function() {
                        ...
                        Ui = true, Pi = setTimeout(function() { Hi = false }, 60)
                    };
                at("History", {
                    publicMethods: {
        ...
        (function() {
            ...
            ! function(e, i, n) {
                ...
                function o(t) {
                    ...
                    if (Pt = t.mobileDeceleration || k, Zt = false !== t.smoothScrolling, jt = t.smoothScrollingDuration || I, Xt = { targetTop: At.getScrollTop() }, Yt = (t.mobileCheck || function() { return /Android|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent || navigator.vendor || e.opera) })(), Yt) {
