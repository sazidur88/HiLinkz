        ...
        <div class="row">
            <div class="col-lg-4 col-md-6" data-aos="fade-up">
                <div class="icon-box">
                    ...
                    <p class="description">RyoGas POS app allows sales people to record gas sales and print receipts for the customers.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <div class="icon-box">
                    <div class="icon"><i data-feather="layers"></i></div>
                    <h4 class="title"><a href="">Sales & Accounting</a></h4>
                    <p class="description">Sales & Accounting app records daily sales summary, gas purchase, gas stock, petty cash and cash statements.</p>
                </div>
            </div>

            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="icon-box">
                    <div class="icon">                                            <i data-feather="layers"></i>
                    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 d-flex align-items-stretch mt-4" data-aos="fade-up">
                <div class="card-no-img">
                    <div class="card-body">
                        <h5 class="card-title">Completely Customizable
                        </h5>
                        <p class="card-text">
            ...
            <div class="col-md-4 d-flex align-items-stretch mt-4" data-aos="fade-up" data-aos-delay="100">
                <div class="card-no-img" >
                    <div class="card-body">
                        <h5 class="card-title">Manage all types of digital assets
                        </h5>
                        <p class="card-text">
