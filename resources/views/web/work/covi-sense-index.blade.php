            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="single-column text-justify">
                        ...
                        <p>Severely infected with the COVID virus causes Pneumonia that associates higher pulse and
                            breathing rates with a lower oxygen saturation level than optimum level. Pulse rate and blood
                            oxygen saturation (SpO2) are two of the major health parameters along with a few more that
                            doctors usually look for and measure to diagnose Pneumonia as well as Bronchitis. To monitor
                            these COVID related vital health parameters we developed <b>CoviSense</b>, an IoT device based
                            on Atmel Atmega 328P-PU and MAX30100 to monitor pulse rate and blood oxygen saturation of COVID
                            patients. We analyzed and compared its performance with a commercially available reference
                            device, Rossmax SB150 pulse oximeter and found that CoviSense was as good as Rossmax but the
                            unit price of CoviSense was around 12 USD only.</p>
                    </div>
                </div>
                <div class="col-lg-12 text-center mt--50 mb--30">
                    <div class="inner-wrapper">
                        <div class="inner pb--20">
                            <div class="thumbnail">
                                <img class=""
                                    src="{{ asset('assets/images/work/covisense/CoviSense_DIAG.jpg') }}" alt="Blog Images">
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="single-column text-justify">
                        ...
                        <p>A <a href="{{ url('storage/uploaded_file/covi_sense_1570708908_Navid Bin Ahmed_Bangladesh_Final Version.pdf') }}"
                                target="_blank" class="text-info font-weight-bold">research paper </a> on the performance
                            analysis of CoviSense has been accepted for presentation in the 2021 IEEE International
                            Conference on IoT, Electronics and Mechatronics (IEMTRONICS), which was held virtually in
                            Toronto, Canada from 21-24 April 2021. The research contribution created quite a good resonance
                            among the audience. Navid and Nuzhat Arifa presented the paper in that conference and won the
                            best presenter title competing with the presenters from 7 other countries in the session. </p>
                    </div>
                </div>
                <div class="col-lg-12 text-center mt--50 mb--30">
                    <div class="inner-wrapper">
                        <div class="inner pb--20">
                            <div class="thumbnail">
                                <img class="" style="max-width:80%"
                                    src="{{ asset('assets/images/work/covisense/CoviSense_Project.jpg') }}"
                                    alt="Blog Images">
                            </div>
                        </div>
                        <span class="font-weight-bold pt--5">Figure 2: Application of CoviSense on children to measure pulse
                            rate (BPM) and SpO2 (%)</span>
                    </div>
                </div>
            </div>
        </div>
