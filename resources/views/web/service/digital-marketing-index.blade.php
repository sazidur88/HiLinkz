    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-6 col-12 mt_sm--30">
                ...
                <p class="text-justify">Email marketing is a flexible, fast and cost effective way of reaching new customers and retaining existing customers. It helps to reach the business to the global customers. Email is the most commonly used feature on the internet; hence it is easy to use and reach the target audience. Email marketing is extremely straightforward in terms of providing information regarding any campaigns or offers.</p>
                <div class="button-group mt--30">
                    <a class="rn-button-style--2 btn_solid btn-size-sm nav-link smoth-animation" href="#contact">Get Started <i class="fas fa-arrow-right"></i></a>
                </div>
                <!-- </div> -->
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-6 col-12 mt_sm--30 ">
                ...
                <p class="text-justify">Effective blogging is an essential part of an overall digital marketing strategy. It drives traffic to the website, generates new leads to the company, helps to nurture those leads and provides the increased insight of the customers. A good blog helps the customers to interact with the company. By providing content through blogs that answers questions of the clients, addresses clients issues, and offers real solutions, this will build a good relationship between the customers and the brand, which in return gives the growth of the company. </p>
                <div class="button-group mt--30">
                    <a class="rn-button-style--2 btn_solid btn-size-sm nav-link smoth-animation" href="#contact">Get Started <i class="fas fa-arrow-right"></i></a>
                </div>
                <!-- </div> -->
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-6 col-12 mt_sm--30">
                ...
                <p class="text-justify">Most of the users look for information on the internet before purchasing anything. This behaviour trend emphasizes the importance of websites for today's business. A website can be the backbone of any business nowadays, which supports all the digital marketing efforts 24/7. Website marketing reaches the customers in a very cost effective way; hence the operational cost becomes very less. With website marketing, any business can measure and keep track of the results of any advertising campaigns, which helps a business to decide if any changes are required. </p>
                <div class="button-group mt--30">
                    <a class="rn-button-style--2 btn_solid btn-size-sm nav-link smoth-animation" href="#contact">Get Started <i class="fas fa-arrow-right"></i></a>
                </div>
                <!-- </div> -->
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-6 col-12 mt_sm--30 ">
                ...
                <p class="text-justify">Contextual advertisement is one of the effective ways of advertising because it reaches the target audience. Contextual advertisements are cost effective because, when the customer clicks on the ads, they are charged for the click only, not for the display of ads on the screen. This type of advertising is helpful for the customers as they readily find the information on the links or the ads they are looking for. This type of advertising helps a brand to connect with customers and get feedback. And since it offers multiple targeting options, ads are seen by the right audience.</p>
                <div class="button-group mt--30">
                    <a class="rn-button-style--2 btn_solid btn-size-sm nav-link smoth-animation" href="#contact">Get Started <i class="fas fa-arrow-right"></i></a>
                </div>
                <!-- </div> -->
