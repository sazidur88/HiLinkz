                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 mt--30 zoom">
                        <div class="standard-service">
                            <div class="thumbnai"><img src="{{asset('assets/images/portfolio/HiLinkzMiniConsultancy.jpg')}}" alt="HiLinkz"></div>
                    ...
                    <div class="col-lg-4 col-md-6 mt--30 zoom">
                        <div class="standard-service">
                            <div class="thumbnai"><img src="{{asset('assets/images/portfolio/HiLinkzMiniWEB.jpg')}}" alt="HiLinkz"></div>
                            <div class="content shadow p-3 mb-3 ">
                    ...
                    <div class="col-lg-4 col-md-6 mt--30 zoom">
                        <div class="standard-service">
                            <div class="thumbnai"><img src="{{asset('assets/images/portfolio/HiLinkzMiniAppDevelopment.jpg')}}" alt="HiLinkz"></div>
                            <div class="content shadow p-3 mb-3 ">
